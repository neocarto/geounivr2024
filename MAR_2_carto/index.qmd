...
Ici, la serie est dissymétrique à gauche, on peut donc opter plutôt pour la méthode `"geom"` qui est adaptée à ce type de distribution (les méthodes disponibles sont :  `"fixed"`, `"sd"`, `"equal"`, `"pretty"`, `"quantile"`, `"kmeans"`, `"hclust"`, `"bclust"`, `"fisher"`, `"jenks"`, `"dpih"`, `"q6"`, `"geom"`, `"arith"`, `"em"` ou `"msd"`).
...
Pour réaliser des cartes combinant deux variables, il est possible de supperposer une carte choroplethe et une carte de stock. Par exemple : 
...
Le système de themes est très flexible. Vous pouvez prendre un theme et le modifier.
...
Le langage R permet  d'embarquer des librairies en JavaScript dans des packages. Cela ouvre la possibilté de réaliser des poroposer des outils de cartographie interactive. Ici, nous parlerons de 2 exemples principaux. 
