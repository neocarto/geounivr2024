...
::: {.column width="49%"}
<img src="img/Mattangs.jpeg" style="border:none"/></img><br/> Ces cartes polynésiennes appelées <b>Rebbelibs</b>, <b>Medosou</b> ou <b>Mattangs</b> représentants les courants marins et la direction de la houle qui est perturbée par la présence des îles avec des batons de bois courbés, les coquillages représentants la position des îles. Elle datent de 1000 av.n.è.
:::
:::
...
::: notes
L'humanité produit des cartes depuis plus de 4000 ans pour se repérer et/ou se déplacer. Petit à petit les représentations du monde se sont affinées. On dispose aujourd'hui de bases de données très précises permetant de représenter le monde. Est-ce "la fin de l'histoire" cartographique ?
:::
...
::: notes
On va s'interesser maintenant à une autre histoire, celle de la visualisation de données. Cette histoire est plus courte. Elle commence vraiment au 18e siecle avec William Playfair et Florence Nightingale.
:::
...
::: notes
Ces deux histoires s'intersectent pour la première fois en 1826 avec la carte figurative de Charles Dupin. Pour la première fois, on représentatait des données statistiques sur un repère géographique. C'est aussi la première carte choroplèthe. S'en suivent de nombreuses autres représentations cartographiques. Les réalisations de C.J. Minard sont particulièrement remarquables.
:::
...
::: notes
Cette façon de représenter des données via des signes graphiques et systhétisée de façon remarquable en 1967 par Jacques Bertin.
:::
...
Il existe une multitude de logiciels permetant de réaliser des cartes ou contribuant à leurs réalisation. Logiciules SVG, logiciels de cartographie clic bouton, logiciels en ligne de commande, logiciels DAO...

<img src="img/logiciels.svg" style="border:none" width="100%"/></img>

## Cartographie reproductible

De l'acquisition de données à la carte finale, on mobilise génralement différents logiciels, libres ou propriétaires. Plus on multiplie les logiciels, plus la chaine de traitement est brisée.

<img src="img/chaine-traitement.png" style="border:none" width="100%"/></img>

Une carte est dite reproductible si elle est accompagnée de tout ce qui a permis de le concevoir.

<img src="img/Peng.png" style="border:none" width="100%"/></img>

Exemple de carte réalisée avec une chaine de traitrement 100% en R.

<img src="img/ironcurtain.png" style="border:none" width="100%"/></img>

[rzine.fr/docs/20191125_ironcurtain](https://rzine.fr/docs/20191125_ironcurtain/index.html)
...
<img src="img/mapsf.png" style="border:none" width="300px/"/></img>
